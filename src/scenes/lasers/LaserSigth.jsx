...
import { columnsLaserSigth } from "../../data/mockColums";
...
const LaserSigth = () => {
  ...
  useReadVisitCustumerByLaserNameQuery('LaserSigth');

  const visitCustumerList = useSelector(state => state.visitCustomerMeasurement.lasersigth);
